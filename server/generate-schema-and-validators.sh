...
npx ajv compile -s schema/ChangeDocServer.json -o schema/ChangeDocServer-validator.js --allowUnionTypes --all-errors --remove-additional=true
npx ajv compile -s schema/DesignDoc.json -o schema/DesignDoc-validator.js --allowUnionTypes --all-errors --remove-additional=true
